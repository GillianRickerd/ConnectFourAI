class Index:
  ...
  def oneBlankTwoInRow(playerNumber, columnNumber, rowState):
    if rowState[columnNumber] == playerNumber and rowState[columnNumber + 1] == 0 and rowState[
  ...
  def blankThreeInRow(playerNumber, columnNumber, rowState):
    if rowState[columnNumber] == 0 and rowState[columnNumber + 1] == playerNumber and rowState[
    columnNumber + 2] == playerNumber and rowState[columnNumber + 3] == playerNumber:
      return columnNumber
